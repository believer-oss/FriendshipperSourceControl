...
This is a refactor of Project Borealis' [UEGitPlugin Fork](https://github.com/ProjectBorealis/UEGitPlugin) that instead uses the Friendshipper API to conduct critical git operations.

Many operations are still executed using the Git CLI directly. 

**Documentation below is from the original Git Plugin's README.**
