...
namespace FriendshipperSourceControlUtils
{
	 ...
	 */
	bool CheckGitAvailability(const FString& InPathToGitBinary, FFriendshipperVersion* OutVersion = nullptr);
	 ...
	 * @param	InRepositoryRoot	The Git repository from where to run the command - usually the Game directory (can be empty)
	 * @param	InFiles				The files to be operated on
	 * @param	FetchRemote			Tells Friendshipper to update the remote status as well or not.
